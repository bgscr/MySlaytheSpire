...
## 1. Subagent Delegation Rule
When spinning up or delegating tasks to a subagent for development work:
- **Model Restriction**: You MUST exclusively use the **extra high 5.5** model. 
- **Strict Compliance**: Do not use any other model versions (lower or alternative) under any circumstances, as the core development relies entirely on CodeX standards.
